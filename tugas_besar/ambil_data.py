#import tweepy,sys,jsonpickle,scrapy
import scrapy
import tweepy
import sys
import jsonpickle

consumer_key = 'KP0hhJqaTWCBVAqgBvkCloRS2' #di isi API key dari akun developer twitter
consumer_secret = '0AKiqwgkeZfgU9fe6SIZU4IRsR4EyB4FhpLnVEroMHVyQKnQlP' #di isi API secret dari akun developer twitter

qry='larangan mudik'#query yang akan di cari
maxTweets =  1000# Isi sembarang nilai sesuai kebutuhan anda
tweetsPerQry = 1000  # Jangan isi lebih dari 100, ndak boleh oleh Twitter
fName='larangan_mudik.json' # Nama File hasil Crawling
...
#https://mobile.twitter.com/hashtag/larangmudik


#https://mobile.twitter.com/search?q=larang%20mudik&src=typed_query